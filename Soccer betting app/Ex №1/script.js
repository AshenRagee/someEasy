'use strict';
//1. Create separate arrays with players for each team (variables players1 and p layers2).
...
const printGoals = function (...gamePlayers) {
	let totalGoals = gamePlayers.length;
	console.log(`All players: ${gamePlayers} and total goals: ${totalGoals}`);
};
printGoals('Mingueza', 'Messi', 'Modrich', 'Nacho');
printGoals(...game.scored);

//7
//console.log((team1 > team2 && team2) || (team2 > team1 && team1));
