...
const currancies = new Map([['USD', 'Unated States dollar']]);

const verifyCats = function (catsJane, catsJulia) {
	//const catsJaneDelDog = catsJane.slice(1, -1);
	const catsJaneDelDog = catsJane.slice();
	catsJaneDelDog.splice(0, 1);
	catsJaneDelDog.splice(-1);
	//console.log(catsJaneDelDog);
	const allCats = catsJaneDelDog.concat(catsJulia);
	//console.log(allCats	);
	allCats.forEach(function (catAge, index) {
		if (catAge < 2) {
